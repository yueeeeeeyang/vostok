...
/** multipart 文本字段解析器。 */
public final class VKFormResolver implements VKMvcArgumentResolver {
    @Override
    public boolean supports(VKMvcMethodInvoker.ParameterSpec parameter) {
        return parameter.source() == VKMvcMethodInvoker.Source.FORM;
    }
    ...
    public Object resolve(VKMvcMethodInvoker.ParameterSpec parameter,
        ...
        try {
            ...
            throw new VKMvcBindException("Invalid form field  + parameter.name() + : " + raw, e);
        }
    }
}
