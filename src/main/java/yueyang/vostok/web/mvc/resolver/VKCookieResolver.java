...
/** Cookie 参数解析器。 */
public final class VKCookieResolver implements VKMvcArgumentResolver {
    @Override
    public boolean supports(VKMvcMethodInvoker.ParameterSpec parameter) {
        return parameter.source() == VKMvcMethodInvoker.Source.COOKIE;
    }
    ...
    public Object resolve(VKMvcMethodInvoker.ParameterSpec parameter,
        ...
        try {
            ...
            throw new VKMvcBindException("Invalid cookie  + parameter.name() + : " + raw, e);
        }
    }
}
