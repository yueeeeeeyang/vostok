package yueyang.vostok.data.type;
    ...
    private static Object mapEnum(Object value, Class<?> targetType) {
        ...
        if (value instanceof Number) {
            ...
            if (ordinal < 0 || ordinal >= values.length) {
                throw new yueyang.vostok.data.exception.VKArgumentException("Enum ordinal out of range: " + ordinal);
            }
            return values[ordinal];
        }

        throw new yueyang.vostok.data.exception.VKArgumentException("Unsupported enum value type: " + value.getClass());
    }
}
