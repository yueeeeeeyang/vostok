 ...
 * MySQL 方言。
 */
public class MySqlDialect implements VKDialect {
    @Override
    ...
    public void appendLimitOffset(StringBuilder sb, Integer limit, Integer offset) {
        ...
        VKAssert.isTrue(offset != null && offset >= 0, "Offset must be >= 0");
        sb.append(" LIMIT 18446744073709551615 OFFSET ").append(offset);
    }
}
