...
import VkLogin from './vk-login/VkLogin.vue';
...
export { VkTable, VkForm, VkSearchBar, VkUpload, VkSelector, VkLogin, VkModalForm, VkDrawerForm, VkAdminLayout };
...
export * from './vk-login/vk-login.types';
