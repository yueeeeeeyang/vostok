...
import { toDefaultValues } from './vk-form-schema';
import type { VkFormProps } from './vk-form.types';

const props = withDefaults(defineProps<VkFormProps>(), {
  initialValues: () => ({}),
  rules: () => []
});
